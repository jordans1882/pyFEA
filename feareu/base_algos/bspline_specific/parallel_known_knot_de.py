...
class ParallelKnownKnotDE(KnownKnotBsplineFeaDE):
    def __init__(self, function, early_stop, domain, delta, true_error, og_knot_points, processes=4, chunksize=4, pop_size=20, mutation_factor = 0.5, crossover_rate = 0.9):
        super().__init__(function, early_stop, domain, delta, true_error, og_knot_points, pop_size, mutation_factor, crossover_rate)
