...
class ParallelKnownKnotGA(KnownKnotBsplineFeaGA):
    def __init__(self, function, early_stop, domain, delta, true_error, og_knot_points, processes=4, chunksize=4, pop_size=20, mutation_rate = 0.05,mutation_range = 0.5,tournament_options = 2,number_of_children = 2):
        super().__init__(function, early_stop, domain, delta, true_error, og_knot_points, pop_size, mutation_rate, mutation_range, tournament_options, number_of_children)
