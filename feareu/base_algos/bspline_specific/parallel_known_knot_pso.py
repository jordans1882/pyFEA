...
class ParallelKnownKnotPSO(KnownKnotBsplineFeaPSO):
    def __init__(self, function, early_stop, domain, delta, true_error, og_knot_points, processes=4, chunksize=4, pop_size=20, phi_p=math.sqrt(2), phi_g=math.sqrt(2), omega=1 / math.sqrt(2)):
        super().__init__(function, early_stop, domain, delta, true_error, og_knot_points, pop_size, phi_p, phi_g, omega)
