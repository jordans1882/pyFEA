...
if __name__ == '__main__':
    ...
    start = time.time()
    fea4 = ParallelBsplineFEA(factors=factors, function = rastrigin__, iterations = 20, dim = factor_number, base_algo_name=FeaPso, domain=(-5, 5), diagnostics_amount=1, og_knot_points=og_knots, process_count=2, generations= 5, pop_size=10)
    fea4.run()
    end = time.time()
