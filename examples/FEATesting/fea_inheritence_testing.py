...
fea1 = BsplineFEA(factors=fct, function = rastrigin__, iterations = 200, dim = 12, base_algo_name=BsplineFeaPSO, domain=(-5, 5), diagnostics_amount=1, generations= 5, pop_size=15)
fea1.run()
