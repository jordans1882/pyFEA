...
fea1 = BsplineFEA(factors=fct, function = rastrigin__, iterations = 100, dim = 10, base_algo_name=FeaPso, domain=domain, diagnostics_amount=1, generations= 5, pop_size=20)
