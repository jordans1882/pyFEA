...
from pyfea.benchmarks.known_knots_de import KnownKnotsDe
from pyfea.benchmarks.known_knots_fea import KnownKnotsFea
from pyfea.benchmarks.known_knots_ga import KnownKnotsGa
from pyfea.benchmarks.known_knots_pso import KnownKnotsPso

fea_tester = KnownKnotsFea(
    number_of_knots=12,
