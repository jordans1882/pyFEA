...
if __name__ == '__main__':
    ...
    #fea1 = ParallelBsplineFEA(factors=fct, function = rastrigin__, iterations = 300, dim = 10, base_algo_name=FeaPso, domain=(-5, 5), process_count=1, generations= 5, pop_size=20)
    fea1 = ParallelBsplineFEA(factors=fct, function = rastrigin__, iterations = 100, dim = 10, base_algo_name=FeaPso, domain=(-5, 5), process_count=2, generations= 5, pop_size=20)
    fea1.run()
