...
from feareu.base_algos import FeaDE, ParallelFeaDE
import time
...
if __name__ == "__main__":
    ...
    ret = np.array([FeaDE(slow_eval, domain[subpop, :], generations = 10, pop_size=50, crossover_rate=0.9, mutation_factor=0.5) for subpop in factors])
