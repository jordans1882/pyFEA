...
from pyfea.base_algos import (FeaDE, FeaGA, ParallelFeaDE, ParallelFeaGA,
                              parallel_eval)
from pyfea.benchmarks import rastrigin__, sphere__
...
alg = FeaGA(
    slow_eval, domain, generations=200, pop_size=500, b=0.7, mutation_range=0.5, mutation_rate=0.05
)
alg.run()
print(alg.best_eval)
t6 = time.time()
