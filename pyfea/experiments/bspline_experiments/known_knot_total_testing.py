...
def create_single_full_set(
    ...
    psoFEA = VectorComparisonBsplineFEA(
        factors=factors,
    ...
    gaFEA = VectorComparisonBsplineFEA(
        factors=factors,
        function=scatter_plot,
        early_stop=fea_early_stop,
        true_error=scatter_plot(knots),
    ...
    deFEA = VectorComparisonBsplineFEA(
        factors=factors,
        function=scatter_plot,
        early_stop=fea_early_stop,
        true_error=scatter_plot(knots),
