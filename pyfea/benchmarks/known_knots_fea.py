...
class KnownKnotsFea:
    ...
    def run(self):
        ...
        interior_knots = np.sort(
            np.random.uniform(0.0, 1.0, self.number_of_knots)
        )  # knot locations
        ...
        testing = VectorComparisonBsplineFEA(
            factors=fct,
            early_stop=50,
            ...
            dim=self.number_of_knots,
            base_algo_name=self.base_algo,
            domain=(0, 1),
            diagnostics_amount=self.diagnostics_amount,
